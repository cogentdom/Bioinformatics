...
public class BTree {
	...
	Boolean bool = false;
	/**
	 * The constructor method for BTree
	 * @param t the load for the nodes 
	 * @param raf Random access file to store data
	 * @throws Exception
	 */
	...
	public void traverseTree(String file, int longVal, int subLength) throws Exception {
		FileWriter fw = new FileWriter(new File(file+".btree.dump."+subLength));
